...
const DEFAULT_SETTINGS = {
  ...
  pointsPerFood: 1,
  seasonalEvent: { active: false, label: '', emoji: '🎉' },
};
...
const MASCOT_IMAGES = {
  ...
  sprout: 'data:image/png;base64,',
...
const SNACK_COOLDOWN_MS = 5 * 60 * 60 * 1000; // ให้อาหารว่างฟรีได้ทุก 5 ชม.
const HUNGRY_AFTER_MS = 12 * 60 * 60 * 1000; // ไม่ได้กินอะไรเกิน 12 ชม. ถือว่าหิว
function defaultMascotRec() {
  return {
    redeemedPoints: 0,
    foodInventory: 0,
    foodGiven: 0,
...
app.get('/api/mascot/:userId', (req, res) => {
  ...
  if (rec.lastFedAt === undefined) { rec.lastFedAt = Date.now(); changed = true; }
  if (rec.lastSnackAt === undefined) { rec.lastSnackAt = 0; changed = true; }
  if (rec.customName === undefined) { rec.customName = ''; changed = true; }
  if (changed) {
  ...
  const isHungry = Date.now() - rec.lastFedAt >= HUNGRY_AFTER_MS;
  const mood = isDirty && isHungry ? 'sad' : isDirty ? 'dirty' : isHungry ? 'hungry' : 'happy';
  const snackElapsed = Date.now() - rec.lastSnackAt;
  const canSnack = snackElapsed >= SNACK_COOLDOWN_MS;
  const snackCooldownMs = canSnack ? 0 : SNACK_COOLDOWN_MS - snackElapsed;
  ...
  res.json({
    ...
    canSnack,
    snackCooldownMs,
    seasonalEvent: settings.seasonalEvent || { active: false },
  });
});

app.post('/api/mascot/:userId/name', express.json(), (req, res) => {
  const fedData = readMascotFed();
  const rec = fedData[req.params.userId] || defaultMascotRec();
  const raw = typeof req.body.name === 'string' ? req.body.name : '';
  rec.customName = raw.trim().slice(0, 20);
  fedData[req.params.userId] = rec;
  writeMascotFed(fedData);
  res.json({ ok: true, customName: rec.customName });
});

app.post('/api/mascot/:userId/snack', express.json(), (req, res) => {
  const fedData = readMascotFed();
  const rec = fedData[req.params.userId] || defaultMascotRec();
  const elapsed = Date.now() - (rec.lastSnackAt || 0);
  if (elapsed < SNACK_COOLDOWN_MS) {
    return res.json({ ok: false, snackCooldownMs: SNACK_COOLDOWN_MS - elapsed });
  }
  rec.lastSnackAt = Date.now();
  rec.lastFedAt = Date.now();
  fedData[req.params.userId] = rec;
  writeMascotFed(fedData);
  res.json({ ok: true, snackCooldownMs: SNACK_COOLDOWN_MS });
});
...
app.post('/api/lottery/:code', express.json(), async (req, res) => {
  try {
    ...
    if (winner.type === 'mascotFood' && order.userId) {
      const fedData = readMascotFed();
      const rec = fedData[order.userId] || defaultMascotRec();
